...
export default function BadgerMart(props) {
    ...
    useEffect(() => {
        ...
        .then(data => {
            console.log(data);
            setSaleItems(data);
            const featured_item = data.find(item => item.featured);
            setFeaturedItems(featured_item);
        })
    }, [])
    ...
    return <div>
        ...
        {featuredItems ? (<p class = "FeaturedLine">Today's featured item is {featuredItems.name} for ${featuredItems.price}!</p>) : (<p class = "FeaturedLine">Loading...</p>)}
        <Container>
            <Row>
            {
